...
struct  CurveControlledBob_t510508761  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_HorizontalBobRange_0() { return static_cast<int32_t>(offsetof(CurveControlledBob_t510508761, ___HorizontalBobRange_0)); }
	...
	inline static int32_t get_offset_of_VerticalBobRange_1() { return static_cast<int32_t>(offsetof(CurveControlledBob_t510508761, ___VerticalBobRange_1)); }
	...
	inline static int32_t get_offset_of_Bobcurve_2() { return static_cast<int32_t>(offsetof(CurveControlledBob_t510508761, ___Bobcurve_2)); }
	inline AnimationCurve_t3342907448 * get_Bobcurve_2() const { return ___Bobcurve_2; }
	inline AnimationCurve_t3342907448 ** get_address_of_Bobcurve_2() { return &___Bobcurve_2; }
	inline void set_Bobcurve_2(AnimationCurve_t3342907448 * value)
	{
		___Bobcurve_2 = value;
		Il2CppCodeGenWriteBarrier(&___Bobcurve_2, value);
	}

	inline static int32_t get_offset_of_VerticaltoHorizontalRatio_3() { return static_cast<int32_t>(offsetof(CurveControlledBob_t510508761, ___VerticaltoHorizontalRatio_3)); }
	...
	inline static int32_t get_offset_of_m_CyclePositionX_4() { return static_cast<int32_t>(offsetof(CurveControlledBob_t510508761, ___m_CyclePositionX_4)); }
	...
	inline static int32_t get_offset_of_m_CyclePositionY_5() { return static_cast<int32_t>(offsetof(CurveControlledBob_t510508761, ___m_CyclePositionY_5)); }
	...
	inline static int32_t get_offset_of_m_BobBaseInterval_6() { return static_cast<int32_t>(offsetof(CurveControlledBob_t510508761, ___m_BobBaseInterval_6)); }
	...
	inline static int32_t get_offset_of_m_OriginalCameraPosition_7() { return static_cast<int32_t>(offsetof(CurveControlledBob_t510508761, ___m_OriginalCameraPosition_7)); }
	inline Vector3_t3525329789  get_m_OriginalCameraPosition_7() const { return ___m_OriginalCameraPosition_7; }
	inline Vector3_t3525329789 * get_address_of_m_OriginalCameraPosition_7() { return &___m_OriginalCameraPosition_7; }
	inline void set_m_OriginalCameraPosition_7(Vector3_t3525329789  value)
	{
		___m_OriginalCameraPosition_7 = value;
	}

	inline static int32_t get_offset_of_m_Time_8() { return static_cast<int32_t>(offsetof(CurveControlledBob_t510508761, ___m_Time_8)); }
